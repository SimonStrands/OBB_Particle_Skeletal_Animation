	...
	speed(1.5f)
{
	...
	inputLayout = new ID3D11InputLayout * [3]{nullptr};
	
	vShader = new ID3D11VertexShader   * [5] { nullptr, nullptr, nullptr };//3 is used
	gShader = new ID3D11GeometryShader * [5]{ nullptr, nullptr };//2 is used
	pShader = new ID3D11PixelShader    * [5] { nullptr, nullptr,nullptr, nullptr };//5 is used
	hShader = new ID3D11HullShader     * [5] { nullptr,nullptr };//2 is used
	dShader = new ID3D11DomainShader   * [5] { nullptr,nullptr };//2 is used
